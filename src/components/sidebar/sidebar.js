...
export function sidebar() {
	return `
		<aside class="col-start-1 col-end-2 row-start-1 row-end-3 bg-sidebar/30 backdrop-blur-3xl p-4 z-10 rounded-[0_12px_12px_0] my-2 max-h-[calc(100vh-16px)] overflow-hidden">
			${mainLink({
